import { List, Col, Image, Layout, Row, Button } from "antd";
...
export class News extends Component {
  render() {
    const data = [
      { title: "Awarding for Business Model" },
      { title: "Awarding for Business Model" },
      { title: "Awarding for Business Model" },
    ];
    return (
            ...
            {data.map((x) => (
              <Col xs={24} md={8} style={{ marginTop: "40px" }}>
                ...
                >
                  ...
                  />
                  <h2 style={{ fontSize: "16px", fontWeight: 700, textAlign: "center" }}>{x.title}</h2>
                  <p style={{ fontSize: "16px", textAlign: "center" }}>{x.title}</p>
                </div>
              </Col>
            ))}
          </Row>
